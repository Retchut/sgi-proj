    ...
    parseTextures(texturesNode) {
        ...
        for (var i = 0; i < texturesChildren.length; i++) {
            ...
            if (textureID == "inherit" || textureID == "none")
                return "Invalid ID for texture number " + i + ": texture IDs cannot be \"inherit\" or \"none\"";
   ...
   */
    parseComponents(componentsNode) {
        ...
        for (var i = 0; i < children.length; i++) {
            ...
            if (textureID == null) {
                this.onXMLMinorError("Missing texture id for component " + component + ". Assuming no texture");
                textureID = "none";
            }
            if (textureID != "none" && textureID != "inherit") {
                if (this.textures[textureID] == null) {
                    this.onXMLMinorError("Texture " + textureID + " of " + componentID + " is not defined. Assuming no texture");
                    textureID = "none";
                } else {
